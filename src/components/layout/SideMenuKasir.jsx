...
import { BiSolidReport } from "react-icons/bi"; // Import ikon laporan  
  ...
  return (  
    <div className="hidden bg-[#541E50] w-[20%] min-w-[350px] max-w-[350px] items-center lg:flex flex-col">  
      ...
      <section className="flex-1 w-full p-5">  
        ...
        {/* Menu Data Laporan */}  
        <ListMenu  
          icon={<BiSolidReport />} // Menggunakan ikon laporan  
          label={"Data Laporan"}  
          href={"/data-laporan/kasir"} // Ganti dengan path yang sesuai  
          active={menu === 7} // Sesuaikan dengan nomor menu  
        />  
        <ListMenu  
          icon={<IoLogOut />}  
          label={"Logout"}  
          ...
          active={menu === 8} // Sesuaikan dengan nomor menu  
        />  
      </section>  
    </div>  
  );  
